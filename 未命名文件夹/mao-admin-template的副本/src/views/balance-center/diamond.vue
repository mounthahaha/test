<template>
  <el-card v-loading="loading" class="diamond">
    ...
    <!-- 新增 -->
    <el-dialog v-model="dialogAddFormVisible" title="新增钻石订单">
...
import { getDiamondList, addDiamond, deleteDiamond, updateDiamond } from '@/api/balance-center';
