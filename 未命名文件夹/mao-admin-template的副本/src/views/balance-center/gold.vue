<template>
  <el-card v-loading="loading" class="gold">
    ...
    <!-- 新增 -->
    <el-dialog v-model="dialogAddFormVisible" title="新增金币订单">
...
import { getGoldList, addGold, deleteGold, updateGold } from '@/api/balance-center';
